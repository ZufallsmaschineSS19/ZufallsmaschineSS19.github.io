...
<ul>
<li>the <em>modulus</em> <span class="math inline">\(M\)</span>, <span class="math inline">\(0 &lt; M\)</span>,</li>
<li>the <em>multiplier</em> <span class="math inline">\(A\)</span>, <span class="math inline">\(0 &lt; A &lt; M\)</span> and</li>
<li>the <em>increment</em> <span class="math inline">\(C\)</span>, <span class="math inline">\(0 \leq C &lt; M\)</span>.</li>
</ul>
...
<p>To now generate a new random number from a starting point <span class="math inline">\(X_{n}\)</span>, we simply calculate</p>
