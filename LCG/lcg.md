...
<p>For the actual test the sequences are <span class="math inline">\(5000\)</span> bits long. We take the original sequence <span class="math inline">\(b\)</span> and calculate for <span class="math inline">\(n \in [1, 5000]\)</span> <span class="math display">\[X_{n} = \sum_{j=1}^{j=5000} b_{j} \oplus b_{j+n}\]</span> The test has passed when <span class="math inline">\(2326 &lt; X_{n} &lt; 2674\)</span> for each <span class="math inline">\(n\)</span>.</p>
