...
<div style="text-align: justify">Was bedeutet eigentlich Zufall? Eine häufige Definition von Zufall ist ein Ereignis, oder das Zusammenwirken vieler einzelner Ereignisse, für das man keine kausale Erklärung finden kann.[3] Florian Aigner sagte dazu:</div>
...
<div style="text-align: justify">Wie könnte man von _Unvorhersehbarkeit_ sprechen, wenn es uns, die etwas vorhersehen können, nicht geben würde? Was soll ein _Erwartungswert_ sein, wenn niemand etwas erwartet?[8]</div>
  <br>
