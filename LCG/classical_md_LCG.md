...
Our third example already makes it hard to tell if these numbers are _good_ pseudo random numbers. But what makes a sequence of pseudo random numbers _good_? The BSI the German Bundesamt für Sicherheit in der Informationstechnik) [[schindler](1)] recommends a series of statistical tests.
